@extends('backoffice.layouts.layoutIndex')

@section('title')
    Bienvenue chez Mon Docteur
@stop
        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="dashboard1.html">Tableau de bord</a>
                    </li>
            ...
            <div class="topbar-right">
                <div class="ib topbar-dropdown">
                    <label for="topbar-multiple" class="control-label">Période de suivi</label>
                    <select id="topbar-multiple" class="hidden">
                        <optgroup label="Filter By:">
                            <option value="1-1">60 Jours Derniers</option>
                            <option value="1-2" selected="selected">60 Jours Derniers</option>
                ...
                <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="row pv10">
                                    ...
                                    <div class="col-xs-7 pl5">
                                        <h6 class="text-muted">Nombre des rendez-vous</h6>
                            ...
                            <div class="panel-body">
                                <div class="row pv10">
                                    <div class="col-xs-5 ph10"><img src="assets/img/pages/clipart1.png"
                                                                    class="img-responsive mauto" alt=""/></div>
                                    <div class="col-xs-7 pl5">
                                        <h6 class="text-muted">Nombre des consultations</h6>
                            ...
                            <div class="panel-body">
                                <div class="row pv10">
                                    <div class="col-xs-5 ph10"><img src="assets/img/pages/clipart2.png"
                                                                    class="img-responsive mauto" alt=""/></div>
                                    <div class="col-xs-7 pl5">
                                        <h6 class="text-muted">Patients satisfaits</h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="panel panel-tile">
                            <div class="panel-body">
                                <div class="row pv10">
                                    <div class="col-xs-5 ph10"><img src="assets/img/pages/clipart3.png"
                                                                    class="img-responsive mauto" alt=""/></div>
                                    <div class="col-xs-7 pl5">
                                        <h6 class="text-muted">Innovations uniques</h6>
                            ...
                            <div class="panel mbn" data-panel-title="false">
                                ...
                                <div class="panel-body pn">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb20">
                                                <div class="text-dark fw700">Janvier - Mars:</div>
                                            ...
                                            <div class="mb20">
                                                ...
                                                Maturité de notre plateforme.
                                            </div>

                                            <div class="mb20">
                                                <div class="text-dark fw700">October - December</div>
                                                Retour à la croissance rapidement.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel" id="spy1">
                                <div class="panel-heading">
                                    <span class="panel-title">Sondage</span>
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="mt20">
                                        ...
                                        <div class="btn btn-default btn-lg mb5">Résultat caché</div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-widget task-widget sort-disable" id="spy11">
                                <div class="panel-heading cursor">
                                    <span class="panel-title">Widgets de tâches</span>
                                </div>
                                <div class="panel-body pn br-t">

                                    <h6 class="fs14 mv20"><i class="fa fa-bell text-alert mr15"></i><span
                                            class="text-muted">Tâches personnelles</span></h6>
                                    <ul class="task-list task-current mb40">
                                        <li class="task-item success">
                                            ...
                                            <div class="task-desc">Supprimer un évenement</div>
                                        ...
                                        <li class="task-item danger">
                                            ...
                                            <div class="task-desc">Publier un évenement</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item primary">
                                            ...
                                            <div class="task-desc">Ajouter nouveau patient</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item info">
                                            ...
                                            <div class="task-desc">Ajouter nouveau médecin</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item warning">
                                            ...
                                            <div class="task-desc">Supprimer patient</div>
                                            <div class="task-menu"></div>
                                        </li>
                                    </ul>

                                    <h6 class="fs14 mb20"><i class="fa fa-check-square-o text-success mr15"></i><span
                                            class="text-muted">Tâches complètes</span></h6>
                                    <ul class="task-list task-completed">
                                        <li class="task-item danger item-checked">
                                            ...
                                            <div class="task-desc">Ajouter pharmacie</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item system item-checked">
                                            ...
                                            <div class="task-desc">Ajouter hôpital</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item item-alert item-checked">
                                            ...
                                            <div class="task-desc">Ajouter sécretaire</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item info item-checked">
                                            ...
                                            <div class="task-desc">Gérer assurances</div>
                                            <div class="task-menu"></div>
                                        </li>
                                        <li class="task-item info item-checked">
                                            <div class="task-handle">
                                            ...
                                            <div class="task-desc">Ajouter laboratoire</div>
                                            <div class="task-menu"></div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="panel" id="spy2">
                                <div class="panel-heading">
                                    <span class="panel-title">Moteurs de recherche</span>
                                </div>
                            ...
                            <div class="panel" id="spy3">
                                <div class="panel-heading">
                                    <span class="panel-title">Liste des navigateurs</span>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel" id="spy5">
                                <div class="panel-heading">
                                    <span class="panel-title">Etat serveur</span>
                                </div>
                                <div class="panel-body pn">
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Mémoire utilisée</span>
                                    ...
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Disque dev/sda1</span>
                                    ...
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Disque dev/sda2</span>
                                    ...
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Disque dev/sda3</span>
                                    ...
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Disque dev/sda4</span>
                                    ...
                                    <div class="progress progress-bar-xl br4">
                                        <div class="progress-bar progress-bar-system" role="progressbar"
                                            ...
                                            <span class="pull-left ph10">Disque dev/sda5</span>
                            ...
                            <div class="panel" id="spy6">
                                <div class="panel-heading">
                                    <span class="panel-title">Liste des administrateurs</span>
                                </div>
                                <div class="panel-body pn">
                            ...
                            <div class="panel" id="spy7">
                                <div class="panel-heading">
                                    <span class="panel-title">Sources de traphiques</span>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                            ...
                            <div class="panel" id="spy8">
                                <div class="panel-heading">
                                    <span class="panel-title">Liste des pays</span>
                                </div>
                            ...
                            <div class="panel" id="spy10">
                                <div class="panel-heading">
                                    <span class="panel-title">Géographie des visiteurs</span>
                                </div>
                                <div class="panel-body">

...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/admin/analysepredef/create">Ajouter une analyse prédéfinie</a>
        </li>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!! Form::open(['route' => 'backoffice.admin.analysepredef.store']) !!}
                                {!! csrf_field() !!}
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="name" class="field prepend-icon"  >
                                            <input type="text" name="name" value="{{ old('name') }}" class="gui-input"
                                                   placeholder="Donner le nom de l'analyse prédéfinie...">
                                ...
                                <div class="section">
                                    <div class="pull-right">
                                        <input  type="submit" value="Créer une analyse prédéfinie" id="create" class="btn btn-bordered btn-primary">
                                    </div>
                                </div>

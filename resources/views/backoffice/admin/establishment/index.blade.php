...
@section('user')
     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/establishment">Liste des établissements</a>
                    </li>
     ...
     @stop
         ...
         @section('lienC')
                      <div>
                        <a href="/backoffice/admin/establishment/create">Créer un établissement</a>
                    </div>     
     @stop
                        ...
                        <div class="table-responsive">
                            <table class="table footable" data-page-navigation=".pagination" data-page-size="4">
                                ...
                                <tr>
                                    ...
                                    <td>{{$establishment->nameE}}</td>
                                    <td>{{$establishment->titre}}</td>
                                    ...
                                    <td>
                                        ...
                                        @foreach($establishment->specialities as $speciality)
                                            {{ $speciality->intituleEtab }}<br>
                                         @endforeach
                                    ...
                                    <td>
                                      ...
                                      <td>
                                      <a href="{{route('backoffice.admin.establishment.edit', $establishment->id)}}"  class="table-icon edit" title="Edit"></a>
                                <a href="/backoffice/admin/establishment/{{$establishment->id}}" class="table-icon delete" title="Delete">
                                </a>
                                    </td>
                                </tr>
                                    @endforeach

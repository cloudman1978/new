...
@stop
     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/user">Liste des utilisateurs</a>
                    </li>
     ...
     @stop
         ...
         @section('lienC')
                      <div>
                        <a href="/backoffice/admin/user/create">Créer un utilisateur</a>
                    </div>     
     @stop
                        ...
                        <div class="table-responsive">
                            <table class="table footable" data-page-navigation=".pagination" data-page-size="4">
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->gradeHonor}}</td>
                                    <td>{{$user->intituleProf}}</td>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                      <a href="{{route('backoffice.admin.user.edit', $user->id)}}"  class="table-icon edit" title="Edit"></a>
                                <a href="/backoffice/admin/user/{{$user->id}}" class="table-icon delete" title="Delete">
                                </a>
                                    </td>
                                </tr>
                                    @endforeach

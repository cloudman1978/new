     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/user/create">Ajouter un utilisateur</a>
                    </li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                        {!! Form::open(array('route' => 'backoffice.admin.user.store',  'files'=> true)) !!}
                                         {!! csrf_field() !!}
                                        <div class="section">
                                    ...
                                    <label for="password_confirmation" class="field-icon">
                                      ...
                                      <div class="section">
                                                <label  class="field select"> 
                                                    ...
                                                    <select  name="role" id="role" required=true value="{{ old('role') }}"> 
                          ...
                          <!-- -------------- /section -------------- -->
                             ...
                             <div class="form-group{{ $errors->has('gradeHonor') ? ' has-error' : '' }}" style="color:red;">
                                ...
                                <div class="pull-right">
                                     <input  type="submit" value="Créer un utilisateur" id="create" class="btn btn-bordered btn-primary">
                                </div>
                            </div>

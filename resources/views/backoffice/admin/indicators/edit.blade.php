...
@section('title')
    Modifier l'indicateur {{ $indicator->name }}
@stop
...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/admin/indicators/{{ $indicator->id}}/edit">Modifier l'indicateur {{ $indicator->name }}</a>
        </li>
                        ...
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!!Form::model($indicator,
                                             [ 'method' => 'patch',
                                             'route' => ['backoffice.admin.indicators.update', $indicator->id]
                                         ]
                                ...
                                <div class="section">
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="name" class="field prepend-icon"  >
                                            <input type="text" name="name" value="{{ $indicator->name }}" class="gui-input">
                                ...
                                <div class="section">
                                    ...
                                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="description" class="field prepend-icon"  >
                                            <input type="text" name="description" value="{{ $indicator->description }}"
                                                   class="gui-input">
                                ...
                                <div class="section">
                                    ...
                                    <div class="form-group{{ $errors->has('unity') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="unity" class="field prepend-icon"  >
                                            <input type="text" name="unity" value="{{ $indicator->unity }}" class="gui-input">
                                ...
                                <div class="section">
                                    ...
                                    <div class="form-group{{ $errors->has('valUs') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="valUs" class="field prepend-icon"  >
                                            <input type="text" name="valUs" value="{{ $indicator->valUs }}" class="gui-input">
                                ...
                                <div class="section">
                                    <div class="pull-right">
                                        <input  type="submit" value="Modifier indicateur médical" id="edit" class="btn btn-bordered btn-primary">
                                    </div>
                                </div>

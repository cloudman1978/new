...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/admin/indicators">Liste des indicateurs médicaux</a>
        </li>
...
@section('lienC')
    <div>
        <a href="/backoffice/admin/indicators/create">Créer un indicateur médical</a>
    </div>
@stop
                        ...
                        <table class="table footable" data-page-navigation=".pagination" data-page-size="6">
                            ...
                            @foreach($indicators as $indicator)
                                <tr>
                                    ...
                                    <td>{{$indicator->unity}}</td>
                                    <td>{{$indicator->valUs}}</td>
                                    <td>
                                        <a href="{{route('backoffice.admin.indicators.edit', $indicator->id)}}"  class="table-icon edit" title="Edit"></a>
                                        <a href="/backoffice/admin/indicators/{{$indicator->id}}" class="table-icon delete" title="Delete">
                                        </a>
                                    </td>
                                </tr>
                            @endforeach

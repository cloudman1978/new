     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/specialite/{{$specialite->id}}">Détail de la spécialité {{$specialite->intituleEtab}}</a>
                    </li>
                            ...
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                    	{!!Form::open(
                                            [
                                                'method' => 'delete',
                                                'route' => ['backoffice.admin.specialite.destroy', $specialite->id]
                                            ])!!}
										<div class="section">
										<div style="width:20%; float:left; line-height: 40px">Intitulé établissement: </div>
                                            <h5>{{$specialite->intituleEtab}}</h5>
                            			</div>
                    <div class="section">
                    <div style="width:20%; float:left; line-height: 40px">Intitulé profession: </div>
                                            <h5>{{$specialite->intituleProf}}</h5>
                                  </div>
									
                        			<div class="section">
                                <div class="pull-right">
                                     <input  type="submit" value="Supprimer spécialité" id="destroy" class="btn btn-bordered btn-primary" onclick="return confirm(&#39;Vous êtes sur vouloir supprimer ?&#39;);">
                                </div>
                            </div>

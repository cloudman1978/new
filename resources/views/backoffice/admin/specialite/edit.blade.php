     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/specialite/{{$specialite->id}}">Modifier la specialité {{$specialite->intituleEtab}}</a>
                    </li>
 ...
 <!-- -------------- Column Center -------------- -->
     ...
     <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        <div class="panel">
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                    	{!!Form::model($specialite,
											[ 'method' => 'patch',
											'route' => ['backoffice.admin.specialite.update', $specialite->id]
										]

										)!!}
										 {!! csrf_field() !!}
										<div class="section">
										<div style="width:20%; float:left; line-height: 40px">Intitulé établissement: </div>
                             				<div class="form-group{{ $errors->has('intituleEtab') ? ' has-error' : '' }}" style="color:red;">
                                    			<label for="intituleEtab" class="field prepend-icon" style="width:80%; float:left">
                                        			<input type="text" name="intituleEtab" value="{{  $specialite->intituleEtab }}" class="gui-input" placeholder="Donner intitulé établissement">
                        ...
                        <div class="section">
                    <div style="width:20%; float:left; line-height: 40px">Intituléprofession : </div>
                                    <div class="form-group{{ $errors->has('intituleProf') ? ' has-error' : '' }}" style="color:red;">
                                          <label for="intituleProf" class="field prepend-icon" style="width:80%; float:left">
                                              <input type="text" name="intituleProf" value="{{  $specialite->intituleProf }}" class="gui-input" placeholder="Donner intitulé profession...">
                                ...
                                <div class="pull-right">
                                     <input  type="submit" value="Modifier spécialité" id="edit" class="btn btn-bordered btn-primary">
                                </div>
                            </div>

...
@stop
     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/specialite">Liste des spécialités</a>
                    </li>
     ...
     @stop
         ...
         @section('lienC')
                      <div>
                        <a href="/backoffice/admin/specialite/create">Créer une spécialité</a>
                    </div>     
     @stop
                ...
                <div class="panel" id="spy3">
                    <div class="panel-body pn">
                        <div class="table-responsive">
                            <table class="table footable" data-page-navigation=".pagination" data-page-size="6">
                                <thead>
                                <tr>
                                    <th class="">#
                                    ...
                                    <th class="">Intitulé établissement
                                        <span class="footbale-sort-indicator">
                                        
                                    </span>
                                    </th> 
                                    <th class="">Intitulé profession
                                        <span class="footbale-sort-indicator">
                                ...
                                <tr>
                                    <td>{{$speciality->id}}</td>
                                    <td>{{$speciality->intituleEtab}}</td>
                                    <td>{{$speciality->intituleProf}}</td>

                                      <td>
                                      <a href="{{route('backoffice.admin.specialite.edit', $speciality->id)}}"  class="table-icon edit" title="Edit"></a>
                                <a href="backoffice/admin/specialite/{{$speciality->id}}" class="table-icon delete" title="Delete">
                                </a>
                                    </td>
                                </tr>
                                    @endforeach

     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/type/create">Ajouter un type d'établissement</a>
                    </li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                        {!! Form::open(['route' => 'backoffice.admin.type.store']) !!}
                                         {!! csrf_field() !!}

                                        <div class="section">
                                       
                                            <div class="form-group{{ $errors->has('titre') ? ' has-error' : '' }}" style="color:red;">
                                                <label for="titre" class="field prepend-icon"  >
                                                    <input type="texte" name="titre" value="{{ old('titre') }}" class="gui-input"
                                                           placeholder="Donner le type d'établissement">
                                ...
                                <div class="pull-right">
                                     <input  type="submit" value="Créer un type" id="create" class="btn btn-bordered btn-primary">
                                </div>
                            </div>

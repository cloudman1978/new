     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/type/{{$type->id}}">Détail du type {{$type->titre}}</a>
                    </li>
                            ...
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                    	{!!Form::open(
                                            [
                                                'method' => 'delete',
                                                'route' => ['backoffice.admin.type.destroy', $type->id]
                                            ])!!}
										<div class="section">
                                ...
                                <div class="pull-right">
                                     <input  type="submit" value="Supprimer type" id="destroy" class="btn btn-bordered btn-primary" onclick="return confirm(&#39;Vous êtes sur vouloir supprimer ?&#39;);">
                                </div>
                            </div>

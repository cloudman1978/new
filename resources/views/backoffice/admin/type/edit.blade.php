...
@section('user')
     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/type/{{$type->id}}">Modifier le type {{$type->titre}}</a>
                    </li>
     ...
     @section('lienC')
                      <div>
                        <a href="/backoffice/admin/type">Retour</a>
                    </div>     
     @stop
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                    <div class="section row" align="center">
                                    	{!!Form::model($type,
											[ 'method' => 'patch',
											'route' => ['backoffice.admin.type.update', $type->id]
										]

										)!!}
										 {!! csrf_field() !!}
										<div class="section">
										<div style="width:20%; float:left; line-height: 40px">Type établissement: </div>
                             				<div class="form-group{{ $errors->has('titre') ? ' has-error' : '' }}" style="color:red;">
                                    			<label for="titre" class="field prepend-icon" style="width:80%; float:left">
                                        			<input type="text" name="titre" value="{{  $type->titre }}" class="gui-input" placeholder="Donner type établissement">

                                        			<label for="titre" class="field-icon">
                                ...
                                <div class="pull-right">
                                     <input  type="submit" value="Modifier type" id="edit" class="btn btn-bordered btn-primary">
                                </div>
                            </div>

...
@section('user')
     ...
     @section('current')
          ...
          <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-active">
                        <a href="/backoffice/admin/type">Liste des types d'établissements</a>
                    </li>
     ...
     @stop
         ...
         @section('lienC')
                      <div>
                        <a href="/backoffice/admin/type/create">Créer un type d'établissement</a>
                    </div>     
     @stop
                            ...
                            <table class="table footable" data-page-navigation=".pagination" data-page-size="6">
                                ...
                                <tr>
                                    ...
                                    <td>{{$type->titre}}</td>
                                      ...
                                      <td>
                                      <a href="{{route('backoffice.admin.type.edit', $type->id)}}"  class="table-icon edit" title="Edit"></a>
                                <a href="/backoffice/admin/type/{{$type->id}}" class="table-icon delete" title="Delete">
                                </a>
                                    </td>
                                </tr>
                                    @endforeach

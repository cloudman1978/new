...
@section('current')
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-icon">
            <span class="fa fa-fa fa-eyedropper"></span>
        </li>
        <li class="breadcrumb-active">
            <a href="backoffice/doctor/patientAnalysis/createRes"> Créer résultat analyse </a>
        </li>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                ...
                                {!!Form::model($pha,
                                   [ 'method' => 'put',
                                   'route' => ['backoffice.doctor.patientAnalysis.storeRes', $pha->id]
                               ]

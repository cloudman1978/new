                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!! Form::open(array('route' => 'backoffice.doctor.patientAnalysis.store')) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="section">
                                    ...
                                    <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}" style="color:red;">
                                        ...
                                        <input type="text" value="{{ $user->name }}" name="user_name"  class="gui-input">
                                        <label class="field-icon" for="user_id">
                                ...
                                <div class="section">
                                    <label  class="field select">
                                        ...
                                        <select name="analysepred_id" id="analysepred_id" onchange='goo()'>
                                            <option value="-1">Choisir analyse...</option>
                                            @foreach($anpre as $an)
                                ...
                                <div class="section">
                                    <div class="pull-right">
                                        <input  type="submit" value="Créer une analyse du patient" id="create" class="btn btn-bordered btn-primary">
                                    </div>
                                </div>

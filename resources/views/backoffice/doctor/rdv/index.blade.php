...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <?php echo  "<a href=".'backoffice/doctor/rdv?date='.$date.">" ?> Liste des rendez-vous </a>
        </li>
...
@section('lienC')
    <div>
        <a href="/backoffice/doctor/rdv/create">Créer un Rendez-vous</a>
    </div>
@stop
        ...
        $("document").ready(function(){
            $("#viewdate").datepicker({
                ...
                onSelect: function(dateText, inst) {
                    ...
                    document.location.href = 'http://localhost:8000/backoffice/doctor/rdv?date=' + dateText;
                }
            });
        });
                ...
                <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        ...
                        <div class="section row" align="center">
                            {!! Form::open(array('route' => 'backoffice.doctor.rdv.pay')) !!}
                            {!! csrf_field() !!}
                        ...
                        <table class="table footable table-bordered toggle-square-filled"
                            ...
                            @foreach($rdvs as $rdv)
                                <tr>
                                    ...
                                    <td>{{$rdv->nameP}}</td>
                                    <td>
                                        <a href="{{route('backoffice.doctor.rdv.edit', $rdv->id)}}"  class="table-icon edit" title="Edit"></a>
                                        <a href="/backoffice/doctor/rdv/{{$rdv->id}}" class="table-icon delete" title="Delete">
                                        </a>

...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/doctor/patient">Liste des patients</a>
        </li>
...
@section('lienC')
    <div>
        <a href="/backoffice/doctor/patient/create">Créer un patient</a>
    </div>
@stop
                        ...
                        <table class="table footable" data-page-navigation=".pagination" data-page-size="4">
                            ...
                            @foreach($patients as $patient)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('backoffice.doctor.patient.edit', $patient->id)}}"  class="table-icon edit" title="Edit"></a>
                                        <a href="/backoffice/doctor/patient/{{$patient->id}}" class="table-icon delete" title="Delete">
                                        </a>
                                    </td>
                                </tr>
                            @endforeach

...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/doctor/patient/rdv">Ajouter un rendez-vous pour client</a>
        </li>
...
@section('lienC')
    <div>
        <a href="/backoffice/doctor/patient/create">Retour</a>
    </div>
@stop
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!! Form::open(array('route' => 'backoffice.doctor.patient.rdv')) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="section">
                                    ...
                                    <label  class="field select">
                                       ...
                                       <input type="text" name="user_neme" value="{{ $users->name }}">

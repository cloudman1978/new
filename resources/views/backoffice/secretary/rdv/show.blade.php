...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/secretary/show/{{$rdv->id}}">Détail Rendez-vous</a>
        </li>
                        ...
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!!Form::open(
                                    [
                                        'method' => 'delete',
                                        'route' => ['backoffice.secretary.rdv.destroy', $rdv->id]
                                    ])!!}
                                <div class="section">
                                ...
                                <div class="section">
                                    <div style="width:20%; float:left; line-height: 40px">Praticien : </div>
                                    <h5>{{$rdv->nameU}}</h5>
                                </div>
                                <div class="section">
                                    <div style="width:20%; float:left; line-height: 40px">Date et heure : </div>
                                    <h5>{{$rdv->hour}}</h5>
                                </div>

                                <div class="section">
                                    <div style="width:20%; float:left; line-height: 40px">Etat : </div>
                                    <h5>
                                        <?php if ($rdv->state == 10){
                                            echo "Non validé";
                                        }
                                ...
                                <div class="section">
                                    <div style="width:20%; float:left; line-height: 40px">Remarques patient : </div>
                                    <h5>{{$rdv->rqs}}</h5>
                                </div>

                                <div class="section">
                                    <div class="pull-right">
                                        <input  type="submit" value="Supprimer Rendez-vous" id="destroy" class="btn btn-bordered btn-primary" onclick="return confirm(&#39;Vous êtes sur vouloir supprimer ?&#39;);">
                                    </div>
                                </div>

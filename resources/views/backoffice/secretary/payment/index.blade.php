...
@section('lienC')
    <div>
        <a href="/backoffice/secretary/payment/create">Créer un paiement</a>
    </div>
@stop
                        ...
                        <table class="table footable" data-page-navigation=".pagination" data-page-size="4">
                            ...
                            @foreach($payments as $payment)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('backoffice.secretary.payment.edit', $payment->id)}}"  class="table-icon edit" title="Edit"></a>
                                        <a href="/backoffice/secretary/payment/{{$payment->id}}" class="table-icon delete" title="Delete">
                                        </a>
                                    </td>
                                </tr>
                            @endforeach

...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/secretary/payment/create">Ajouter un nouveau paiement</a>
        </li>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="section row" align="center">
                                {!! Form::open(array('route' => 'backoffice.secretary.payment.store')) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="section">
                                    <label  class="field select">
                                        ...
                                        <select name="rdv_id" id="rdv_id" >
                                            @foreach($rdvs as $rdv)
                                                <option value="{{$rdv->id}}">{{$rdv->patient}}
                                                    {{$rdv->hour}}</option>
                                            @endforeach
                                        </select>
                                        <i class="arrow"></i>

...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/secretary/patient/create">Ajouter un nouveau patient</a>
        </li>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!! Form::open(array('route' => 'backoffice.secretary.patient.store')) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="section">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="name" class="field prepend-icon">
                                            <input type="text" name="name" class="gui-input" value="{{ old('name') }}"
                                ...
                                <div class="section">
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="email" class="field prepend-icon">
                                            <input type="text" name="email" class="gui-input" value="{{ old('email') }}"
                                ...
                                <div class="section">
                                    <div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}" style="color:red;">
                                        <label for="tel" class="field prepend-icon"  >
                                            <input type="texte" name="tel" value="{{ old('tel') }}"

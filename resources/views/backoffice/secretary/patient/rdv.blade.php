...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/secretary/patient/rdv">Ajouter un rendez-vous pour client</a>
        </li>
...
@section('lienC')
    <div>
        <a href="/backoffice/secretary/patient/create">Retour</a>
    </div>
@stop
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!! Form::open(array('route' => 'backoffice.secretary.patient.rdv')) !!}
                                {!! csrf_field() !!}
                                ...
                                <div class="section">
                                    <label for="patient_id" class="field prepend-icon">
                                        <input type="hidden" name="patient_id" class="gui-input"
                                            value="{{ $patient->id }}"   >
                                        <input type="text" name="patient_name" class="gui-input"
                                               value="{{ $patient->name }}">
                                ...
                                <div class="section">
                                    <label for="patient_id" class="field prepend-icon">
                                        <input type="hidden" name="establishment_id" class="gui-input"
                                               value="{{ $establishment->id }}"   >
                                        <input type="text" name="establishment_name" class="gui-input"
                                               value="{{ $users[0]->nameE }}">
                                        <label for="establishment_id" class="field-icon">
                                            <i class="fa fa-user-md"></i>
                                        </label>
                                    </label>
                                </div>
                                ...
                                <div class="section">
                                    ...
                                    <label  class="field select">
                                        ...
                                        <select name="user_id" id="user_id" style='display:inline'>
                                            <option value="-1">Choisir un docteur</option>

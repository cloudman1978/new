...
@section('current')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-active">
            <a href="/backoffice/secretary/patientAnalysis/show/{{ $pha->id }}">Détail de l'analyse patient {{ $pha->name }}</a>
        </li>
                        ...
                        <div class="panel-body">
                            <div class="section row" align="center">
                                {!!Form::open(
                                    [
                                        'method' => 'delete',
                                        'route' => ['backoffice.secretary.patientAnalysis.destroy', $pha->id]
                                    ])!!}
                                <div class="section">

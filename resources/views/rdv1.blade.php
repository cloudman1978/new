                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <ol class="tg-breadcrumb">
                            ...
                            <li class="active">Détails consultation</li>
                        </ol>
                    </div>
                </div>
            </div>
...
//    Click Function for Map Banner
        ...
        <div class="container">
            ...
            alt="image description"></figure>';
                                ...
                                {!!Form::model($user,
                                                                       [ 'method' => 'PATCH',
                                                                      'route'=>['rdv2', $user->idUE."/?heure=".$_GET['heure'] ]
                                                                   ]
                                ...
                                <div class="tg-reviewbox">
                                    <div class="tg-heading-border tg-small">
                                        <h2>Avez vous consulté ce praticien auparavant? </h2>
                                    </div>
                                    <div class="option-group field" name="nDoct">
                                        <label class="option block">
                                            <input type="radio" name="nDoct" value="0" checked >
                                            <span class="radio" style="display: inline-block">Je suis un nouveau patient</span></label><br>
                                        <label class="option block">
                                            <input type="radio" name="nDoct" value="1" >
                                            <span class="radio" style="display: inline-block">Je suis déjà patient de ce médecin</span></label>

                                    </div>
                                </div>
                                <div class="tg-doc-feature">
                                    <div class="tg-heading-border tg-small">
                                        <h3>Vérifiez l'heure du rendez-vous s'il vous plaît</h3>
                                    </div>
                                    <div class="tg-description">
                                        <div>
                                            <a style="float: left;">
    <span id="horaire">
        ...
        echo  date("Y:m:d:H:i", $date); ?>
                                        ...
                                        <div class="input-group-btn btn_promo_search">
                                            <button type="submit" class="tg-btn">Prendre RDV</button>
                                        </div>
                        ...
                        */
                                                ...
                                                echo '<div class="col-md-6 calender_item"><a href="/rdv2/'.$user->idUE.'?heure='.($h+$index_week+($k *60 *60 *24)).'">'.date("H:i",$h)."</a></div>";
                                                }
                                                echo '</div>';
                                                }
                                                ?>

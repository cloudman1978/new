...
class DoctorPatientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backoffice.doctor.patient.index')
    ...
    public function create()
    {
        ...
        $date = date('Y-m-d', time());
        return view('backoffice.doctor.patient.create')
...
*/
        ...
        return view('backoffice.doctor.patient.rdv')
    ...
    public function show($id)
    {
        ...
        $establishment = Establishment::find($ide);
        $type = Type::find($establishment->type_id);
        return view('backoffice.doctor.patient.show')
            ->with('patient', $patient)
            ->with('insurances', $insurances)
            ->with('type', $type)
            ->with('date', $date);
    ...
    public function edit($id)
    {
        ...
        $inss = Insurance::all();
        $date = date('Y-m-d', time());
        return view('backoffice.doctor.patient.edit')
            ->with('patient', $patient)
            ->with('insurances', $insurances)
            ->with('inss', $inss)
            ->with('date', $date)
    ...
    public function update(Request $request, $id)
    {
        ...
        $date = date('Y-m-d', time());
        return redirect()->route('backoffice.doctor.patient.index')
            ->with('date', $date)
            ->with('type', $type);
    }
    ...
    public function rdv(Request $request)
    {
        ...
        */
        ...
        $type = Type::find($establishment->type_id);
        $date = date('Y-m-d', time());
        return redirect()->action('DoctorPatientController@index')
            ->with('date', $date)
            ->with('type', $type);
    }
}
